...
Pod::Spec.new do |s|
  s.name             = 'BittyBird'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BittyBird.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Nick Eneboe/BittyBird'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nick Eneboe' => 'neneboe@gmail.com' }
  s.source           = { :git => 'https://github.com/Nick Eneboe/BittyBird.git', :tag => s.version.to_s }
